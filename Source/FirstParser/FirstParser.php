<?php
	class FirstParser_Config extends Project_Config
	{
...
//			$this->m_xAssetArray = ProjectGen_ParseDirectory(dirname(__FILE__) . "/../../Assets", "/\.bin$|\.ttf$|\.xm$|\.binsfx$/");
		...
		public function GetName() { return "FirstParser"; }
		...
		public function GetBundleIdentifier() { return "com.numbatlogic.firstparser"; }
